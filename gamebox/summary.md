# GameBox Modules Summary

This document summarizes the GameBox modules under `modules/`. Each entry states the main capability the module provides. The 3D coordinate system is right-handed.

Module dependencies:

1. ThreeJS: `three@0.161.0` (ESM build `three.module.js`)
2. Rapier3D: `@dimforge/rapier3d-compat@0.14.0` (ESM build `rapier.es.js`)
