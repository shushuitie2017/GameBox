---
name: gamebox
description: Use when building or revising browser-based 3D games with GameBox modules, especially for coordinate systems, actor motion, camera rigs, collision-aware movement, gameplay state, and world building.
---

# GameBox

Use GameBox as source material before inventing 3D game systems from scratch.
...
- Create `gamebox_usage.md` documenting the selected modules, their purpose, reuse/adaptation status, key changes, and game integration.